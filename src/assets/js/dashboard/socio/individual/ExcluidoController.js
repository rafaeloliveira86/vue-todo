$(document).ready(function() {
    $('#dt_socio_individual_excluido').DataTable({
        "paging": true,
        "searching": true,
        "ordering": true,
        "info": true,
        ...
        "order": [],
        "ajax": {
            url: base_url + '/dashboard/listar/socio/individual/datatable',
            type: "POST",
            data: {
                'status': 3
            }
    ...
    $(document).on('click', '[id="btn_editar"]', function(e) {
        ...
        window.location.href = base_url + '/dashboard/socio/individual/editar/'+id;
    });
});