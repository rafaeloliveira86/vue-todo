...
$.extend($.validator, {
	...
	messages: {
		...
		equalTo: "Valor não correspondente.",
...
// CEP (Formato: 00000-000) - CEP com traço
jQuery.validator.addMethod("cep",function(e,t){return this.optional(t)||/^\d{5}-\d{3}?$/.test(e)},"Informe um CEP válido.");
// CEP 2 (Formato: 00000000) - CEP sem traço
jQuery.validator.addMethod("cep2",function(e,t){return this.optional(t)||/^\d{5}\d{3}?$/.test(e)},"Informe um CEP válido.");