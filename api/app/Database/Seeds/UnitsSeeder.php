...
class UnitsSeeder extends Seeder {
    public function run() {
		...
		$arrUnit = [
			...
			['unit_name' => 'Colégio Aplicação Taquara', 'class' => 'yellow darken-3', 'logo_navbar' => 'logo_cca_tq.png', 'logo_footer' => 'logo_cca_tq.png', 'icon_footer' => 'icon_cca.png', 'site' => 'https://aplicacao.rio.br/taquara', 'id_status' => 1, 'id_user_created' => 1, 'id_user_updated' => 0, 'id_user_deleted' => 0, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('0000-00-00 00:00:00'), 'deleted_at' => date('0000-00-00 00:00:00')],
			['unit_name' => 'Colégio Aplicação Vila Militar', 'class' => 'yellow darken-3', 'logo_navbar' => 'logo_cca_vm.png', 'logo_footer' => 'logo_cca_vm.png', 'icon_footer' => 'icon_cca.png', 'site' => 'https://aplicacao.rio.br/vilamilitar', 'id_status' => 1, 'id_user_created' => 1, 'id_user_updated' => 0, 'id_user_deleted' => 0, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('0000-00-00 00:00:00'), 'deleted_at' => date('0000-00-00 00:00:00')],
		];
