...
class UnitsSeeder extends Seeder {
    public function run() {
		...
		$arrUnit = [
			...
			['unit_nickname' => 'CR', 'unit_name' => 'Colégio Realengo', 'class' => 'red darken-4', 'logo_navbar' => 'logo_cr_white.png', 'logo_footer' => 'logo_cr_red.png', 'icon_footer' => 'icon_cr.png', 'site' => 'https://colegiorealengo.br', 'id_status' => 1, 'id_user_created' => 1, 'id_user_updated' => 0, 'id_user_deleted' => 0, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('0000-00-00 00:00:00'), 'deleted_at' => date('0000-00-00 00:00:00')],
			['unit_nickname' => 'CCA.TQ', 'unit_name' => 'Colégio Aplicação Taquara', 'class' => 'teal darken-2', 'logo_navbar' => 'logo_cca_tq_white.png', 'logo_footer' => 'logo_cca_tq_blue.png', 'icon_footer' => 'icon_cca.png', 'site' => 'https://aplicacao.rio.br/taquara', 'id_status' => 1, 'id_user_created' => 1, 'id_user_updated' => 0, 'id_user_deleted' => 0, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('0000-00-00 00:00:00'), 'deleted_at' => date('0000-00-00 00:00:00')],
			['unit_nickname' => 'CCA.VM', 'unit_name' => 'Colégio Aplicação Vila Militar', 'class' => 'teal darken-2', 'logo_navbar' => 'logo_cca_vm_white.png', 'logo_footer' => 'logo_cca_vm_blue.png', 'icon_footer' => 'icon_cca.png', 'site' => 'https://aplicacao.rio.br/vilamilitar', 'id_status' => 1, 'id_user_created' => 1, 'id_user_updated' => 0, 'id_user_deleted' => 0, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('0000-00-00 00:00:00'), 'deleted_at' => date('0000-00-00 00:00:00')],
		];
